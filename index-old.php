...
<html lang="en">
  ...
  <head>
    ...
    <title>HelloGowda | Home Page</title>
...
?>
          ...
          <div class="card mb-4">
 <img class="card-img-top img-thumbnail" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
