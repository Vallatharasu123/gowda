...
{ 
    ...
    if(isset($_POST['update']))
    {
        ...
        if($query)
        {
            $msg="Terms and Conditions page successfully updated";
        }
        else{
...
<head>
    ...
    <title>HelloGowda | Terms and Conditions Page</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Terms and Conditions Page</h4>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="p-6">
                                <div class="">
                                    <form name="termsandconditions" method="post">
    ...
    <script>
        jQuery(document).ready(function(){
            $('.summernote').summernote({
                height: 240, minHeight: null, maxHeight: null, focus: false
            });
            $(".select2").select2();
